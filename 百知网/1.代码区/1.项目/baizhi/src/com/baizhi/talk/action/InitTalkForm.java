...
/**
 * 
 * 类名：InitTalkForm.java
 * 描述： 话题信息表控制类，负责初始化新增操作参数
 * 创建者：江红
 ...
 * 修改日期：
 */
public class InitTalkForm extends ActionSupport{
	
	private static final long serialVersionUID = -6543130982307821031L;
