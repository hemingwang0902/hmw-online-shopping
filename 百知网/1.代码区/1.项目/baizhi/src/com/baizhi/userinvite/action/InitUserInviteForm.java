...
/**
 * 
 * 类名：InitUserInviteForm.java
 * 描述： 用户邀请信息表控制类，负责初始化新增操作参数
 * 创建者：江红
 ...
 * 修改日期：
 */
public class InitUserInviteForm extends ActionSupport{
	
	private static final long serialVersionUID = -144761222965328646L;
