...
/**
 * 
 * 类名：InitScoreForm.java
 * 描述： 积分信息表控制类，负责初始化新增操作参数
 * 创建者：江红
 ...
 * 修改日期：
 */
public class InitScoreForm extends ActionSupport{
	
	private static final long serialVersionUID = 6491203299640838848L;
