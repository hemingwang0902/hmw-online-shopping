...
/**
 * 类名：InitAnswerReviewForm.java<br>
 * 描述： 问题答案评论信息表控制类，负责初始化新增操作参数<br>
 * 创建者：何明旺<br>
 ...
 * 修改日期：
 */
public class InitAnswerReviewForm extends ActionSupport{
	private static final long serialVersionUID = -2331073304916596587L;
