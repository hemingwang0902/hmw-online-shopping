...
/**
 * 
 * 类名：InitUserPrivateForm.java
 * 描述： 用户私信信息表控制类，负责初始化新增操作参数
 * 创建者：江红
 ...
 * 修改日期：
 */
public class InitUserPrivateForm extends ActionSupport{
	
	private static final long serialVersionUID = 1629007002321316015L;
