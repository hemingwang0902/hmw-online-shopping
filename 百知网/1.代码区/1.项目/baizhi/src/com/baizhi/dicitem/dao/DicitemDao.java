...
public class DicitemDao extends DaoSupport {
	...
	public List<Map<String, Object>> getDicitemByCode(String CODE) {
		...
		sql.append("SELECT new Map(").append("a.DICITEM_ID as DICITEM_ID,")//字典清单ID
				...
				.append("FROM T_DICITEM a WHERE a.CODE=? ");
		return this.getByList(sql.toString(), new Object[] { CODE });
	}
