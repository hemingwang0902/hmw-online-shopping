...
/**
 * 类名：InitProblemInviteForm.java<br>
 * 描述： 问题邀请人信息表控制类，负责初始化新增操作参数<br>
 * 创建者：何明旺<br>
 ...
 * 修改日期：
 */
public class InitProblemInviteForm extends ActionSupport{
	private static final long serialVersionUID = 555763748463815930L;
