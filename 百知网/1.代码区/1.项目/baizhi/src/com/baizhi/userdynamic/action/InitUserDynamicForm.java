...
/**
 * 
 * 类名：InitUserDynamicForm.java
 * 描述： 用户动态信息表控制类，负责初始化新增操作参数
 * 创建者：江红
 ...
 * 修改日期：
 */
public class InitUserDynamicForm extends ActionSupport{
	
	private static final long serialVersionUID = -8221171374430937822L;
