...
/**
 * 类名：InitProblemAnswerForm.java<br>
 * 描述： 问题答案信息表控制类，负责初始化新增操作参数<br>
 * 创建者：何明旺<br>
 ...
 * 修改日期：
 */
public class InitProblemAnswerForm extends ActionSupport{
	private static final long serialVersionUID = -1355335389125662896L;
