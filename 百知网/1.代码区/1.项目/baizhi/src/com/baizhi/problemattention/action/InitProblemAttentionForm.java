...
/**
 * 类名：InitProblemAttentionForm.java<br>
 * 描述： 问题关注信息表控制类，负责初始化新增操作参数<br>
 * 创建者：何明旺<br>
 ...
 * 修改日期：
 */
public class InitProblemAttentionForm extends ActionSupport{
	private static final long serialVersionUID = 8516355816205865401L;
