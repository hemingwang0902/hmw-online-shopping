...
/**
 * 
 * 类名：InitUserBasicForm.java
 * 描述： 用户基本信息表控制类，负责初始化新增操作参数
 * 创建者：江红
 ...
 * 修改日期：
 */
public class InitUserBasicForm extends ActionSupport{
	
	private static final long serialVersionUID = 34383819310708540L;
