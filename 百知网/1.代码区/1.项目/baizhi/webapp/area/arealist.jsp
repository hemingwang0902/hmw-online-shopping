...
<script type="text/javascript" language="javascript"  src="arealist.js"></script>
</head>
<body>
	...
	<div class="content">
		<div class="find_box">
			...
			<form id="AreaList" >
				<table width="100%;" border="0" cellspacing="0" cellpadding="0" class="lightbox_table">
		   			<tr>
						<td class="lightbox_title">地区ID：</td>
					
						<td class="lightbox_content"><input type="text" class="input_width3" name="AREA_ID" id="AREA_ID" /> </td>
	
					</tr>
		   			<tr>
						<td class="lightbox_title">地区代码：</td>
					
						<td class="lightbox_content"><input type="text" class="input_width3" name="DIC_CODE" id="DIC_CODE" /> </td>
	
					</tr>
		   			<tr>
						<td class="lightbox_title">地区名称：</td>
					
						<td class="lightbox_content"><input type="text" class="input_width3" name="DIC_NAME" id="DIC_NAME" /> </td>
	
					</tr>
		   			<tr>
						<td class="lightbox_title">地区上级代码：</td>
					
						<td class="lightbox_content"><input type="text" class="input_width3" name="PAREA_ID" id="PAREA_ID" /> </td>
	
					</tr>
		   			<tr>
						<td class="lightbox_title">地区全拼：</td>
					
						<td class="lightbox_content"><input type="text" class="input_width3" name="ALLPIN" id="ALLPIN" /> </td>
	
					</tr>
		   			<tr>
						<td class="lightbox_title">地区简拼：</td>
		   			...
		   			<tr>
						<td class="lightbox_title">IP起始段：</td>
					
						<td class="lightbox_content"><input type="text" class="input_width3" name="IP_START" id="IP_START" /> </td>
	
					</tr>
		   			<tr>
						<td class="lightbox_title">IP终止段：</td>
					
						<td class="lightbox_content"><input type="text" class="input_width3" name="IP_END" id="IP_END" /> </td>
	
					</tr>
		   			<tr>
						<td class="lightbox_title">地区级别：</td>
					
						<td class="lightbox_content"><input type="text" class="input_width3" name="AREA_LEVEL" id="AREA_LEVEL" /> </td>
		...
		<div class="table_box">
			<div class="lightbox_header">
				<span class="font_span">地区信息表列表</span>
			</div>
			<div class="lightbox_opt">
				<input type="button"  value="新增" class="button_box" onclick="location.href='initAreaForm.go';"/>
				...
				<table width="100%;" border="0" cellspacing="0" cellpadding="0" class="lightbox_table" id="datalist">
					<tr class="tr_bg">
						...
						<td width="10%">操作</td>
		   				...
		   				<td width="10%">地区代码</td>
		   				<td width="10%">地区名称</td>
		   				<td width="10%">地区上级代码</td>
		   				<td width="10%">地区全拼</td>
		   				<td width="10%">地区简拼</td>
		   				<td width="10%">显示顺序</td>
		   				<td width="10%">IP起始段</td>
		   				<td width="10%">IP终止段</td>
		   				<td width="10%">地区级别</td>
		   				<td width="10%">备注</td>
					</tr>
				</table> 
