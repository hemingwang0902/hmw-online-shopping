...
<script type="text/javascript" language="javascript"  src="provincelist.js"></script>
</head>
<body>
	...
	<div class="content">
		...
		<div class="table_box">
			<div class="lightbox_header">
				<span class="font_span">省份信息列表</span>
			</div>
			<div class="lightbox_opt">
				<input type="button"  value="新增" class="button_box" onclick="location.href='initAreaForm.go?AREA_LEVEL=1';"/>
