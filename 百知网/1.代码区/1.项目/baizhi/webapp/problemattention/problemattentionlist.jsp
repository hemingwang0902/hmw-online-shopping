...
<script type="text/javascript" language="javascript"  src="problemattentionlist.js"></script>
</head>
<body>
...
<div class="container">
	<div class="content">
		<div class="find_box">
			...
			<form id="ProblemAttentionList" >
				<table width="100%;" border="0" cellspacing="0" cellpadding="0" class="lightbox_table">
		   			<tr>
						<td class="lightbox_title">问题关注ID：</td>
						<td class="lightbox_content"><input type="text" class="input_width3" name="ATTENTION_ID" id="ATTENTION_ID" /> </td>
					</tr>
		   			<tr>
		...
		<div class="table_box">
			<div class="lightbox_header">
				<span class="font_span">问题关注信息表列表</span>
			</div>
			<div class="lightbox_opt">
				<input type="button"  value="新增" class="button_box" onclick="location.href='initProblemAttentionForm.go';"/>
