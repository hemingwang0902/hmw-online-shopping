...
<script type="text/javascript" language="javascript" src="problemattentionform.js"></script>
</head>
<body>
...
<div class="container">
	<div class="content">
		...
		<form action="saveProblemAttention.go" method="post" id="ProblemAttentionForm">
			<input type="hidden"  id="ATTENTION_ID" name="ATTENTION_ID" value='<s:property value="ATTENTION_ID"/>' />
			<s:token></s:token>
			<input type="hidden" id="ID" name="ID" value='<s:property value="ID"/>'/>
			<div class="lightbox_header"><span class="font_span">问题关注信息表表单</span></div>
			<div class="btn_box">
				<input type="submit" value="保存" class="button_box"/>
				<input type="button" value="返回" onclick="location.href='problemattentionlist.jsp';" class="button_box"/>
			</div>
