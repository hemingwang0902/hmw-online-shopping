...
<script type="text/javascript" language="javascript"  src="answervotelist.js"></script>
</head>
<body>
...
<div class="container">
	<div class="content">
		<div class="find_box">
			...
			<form id="AnswerVoteList" >
				<table width="100%;" border="0" cellspacing="0" cellpadding="0" class="lightbox_table">
		   			<tr>
						<td class="lightbox_title">问题答案投票ID：</td>
						<td class="lightbox_content"><input type="text" class="input_width3" name="VOTE_ID" id="VOTE_ID" /> </td>
					</tr>
		   			<tr>
		   			...
		   			<tr>
						<td class="lightbox_title">问题ID(冗余字段)：</td>
						<td class="lightbox_content"><input type="text" class="input_width3" name="PROBLEM_ID" id="PROBLEM_ID" /> </td>
					</tr>
		   			<tr>
						<td class="lightbox_title">投票类型(字典：1赞成Or拒绝、2感谢作者Or没有帮助)：</td>
						<td class="lightbox_content"><input type="text" class="input_width3" name="VOTE_TYPE" id="VOTE_TYPE" /> </td>
					</tr>
		   			<tr>
						<td class="lightbox_title">是否赞成、感谢(0否、1是)：</td>
						<td class="lightbox_content"><input type="text" class="input_width3" name="IS_AGREE" id="IS_AGREE" /> </td>
					</tr>
		   			<tr>
		...
		<div class="table_box">
			<div class="lightbox_header">
				<span class="font_span">问题答案投票信息表列表</span>
			</div>
			<div class="lightbox_opt">
				<input type="button"  value="新增" class="button_box" onclick="location.href='initAnswerVoteForm.go';"/>
			...
			<div class="list_style">
				<table width="100%;" border="0" cellspacing="0" cellpadding="0" class="lightbox_table" id="datalist">
					<tr class="tr_bg">
						...
						<td width="10%">操作</td>
		   				<td width="10%">问题答案投票ID</td>
		   				<td width="10%">问题答案ID</td>
		   				<td width="10%">问题ID(冗余字段)</td>
		   				<td width="10%">投票类型(字典：1赞成Or拒绝、2感谢作者Or没有帮助)</td>
		   				<td width="10%">是否赞成、感谢(0否、1是)</td>
		   				<td width="10%">用户ID</td>
		   				<td width="10%">创建时间</td>
		   				<td width="10%">修改时间</td>
					</tr>
