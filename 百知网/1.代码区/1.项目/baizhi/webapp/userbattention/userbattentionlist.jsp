...
<script type="text/javascript" language="javascript"  src="userbattentionlist.js"></script>
</head>
<body>
...
<div class="container">
	<div class="content">
		<div class="find_box">
			...
			<form id="UserBattentionList" >
				<table width="100%;" border="0" cellspacing="0" cellpadding="0" class="lightbox_table">
		   			<tr>
						<td class="lightbox_title">用户关注品牌ID：</td>
						<td class="lightbox_content"><input type="text" class="input_width3" name="BATTENTION_ID" id="BATTENTION_ID" /> </td>
					</tr>
		   			<tr>
		   			...
		   			<tr>
						<td class="lightbox_title">被关注品牌：</td>
						<td class="lightbox_content"><input type="text" class="input_width3" name="BRAND_ID" id="BRAND_ID" /> </td>
					</tr>
		   			<tr>
		...
		<div class="table_box">
			<div class="lightbox_header">
				<span class="font_span">用户关注品牌信息表列表</span>
			</div>
			<div class="lightbox_opt">
				<input type="button"  value="新增" class="button_box" onclick="location.href='initUserBattentionForm.go';"/>
			...
			<div class="list_style">
				<table width="100%;" border="0" cellspacing="0" cellpadding="0" class="lightbox_table" id="datalist">
					<tr class="tr_bg">
						...
						<td width="10%">操作</td>
		   				<td width="10%">用户关注品牌ID</td>
		   				<td width="10%">用户ID</td>
		   				<td width="10%">被关注品牌</td>
