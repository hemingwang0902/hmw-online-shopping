...
<script type="text/javascript" language="javascript" src="userbattentionform.js"></script>
</head>
<body>
...
<div class="container">
	<div class="content">
		...
		<form action="saveUserBattention.go" method="post" id="UserBattentionForm">
			<input type="hidden"  id="BATTENTION_ID" name="BATTENTION_ID" value='<s:property value="BATTENTION_ID"/>' />
			<s:token></s:token>
			<input type="hidden" id="ID" name="ID" value='<s:property value="ID"/>'/>
			<div class="lightbox_header"><span class="font_span">用户关注品牌信息表表单</span></div>
			<div class="btn_box">
				<input type="submit" value="保存" class="button_box"/>
				<input type="button" value="返回" onclick="location.href='userbattentionlist.jsp';" class="button_box"/>
			</div>
			<div class="form_style">
				<table width="100%;" border="0" cellspacing="0" cellpadding="0" class="lightbox_table">
					<tr>
						...
						<td class="lightbox_title"><span class="font_red">*</span>被关注品牌：</td>
						<td class="lightbox_content"><input type="text" class="input_width" id="BRAND_ID" name="BRAND_ID" value='<s:property value="BRAND_ID"/>'/></td>
					</tr>
					<tr>
