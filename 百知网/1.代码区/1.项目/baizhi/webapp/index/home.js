	...
	$.post(action,{
		...
		if (data != null && data["list"] != null && data["list"].length > 0) {
			...
			for(var i=0;i<data["list"].length;i++){
				...
				content += "  		 <img src='../images/ico_sina.gif' alt='新浪微博' width='16' height='16' hspace='2' align='absmiddle' style='cursor:pointer;' onclick='window.open(\"http://v.t.sina.com.cn/share/share.php?appkey=2684493555&url="+path.problem.detail +PROBLEM_ID+"\")' />";
				content += "  		 <img src='../images/ico_qq_t.png' alt='腾讯微博' width='16' height='16' hspace='2' align='absmiddle'  style='cursor:pointer;' onclick='window.open(\"http://v.t.qq.com/share/share.php?url="+path.problem.detail +PROBLEM_ID+"\")'/>";
				content += "  		<img src='../images/ico_msn.png' alt='MSN' width='16' height='16' hspace='2' align='absmiddle' style='cursor:pointer;' onclick='window.open(\"http://profile.live.com/Badge/?wa="+path.problem.detail +PROBLEM_ID+"\")'/>";
