...
<div class="login_home" style="background:#ccdba2;">
	<div class="login_h_logo"><img src="../images/main/login_h_l.png" width="200px" height="55px"/></div>
  <div class="login_h_jj">一个有趣的网络问答社区，分享知识，发现价值</div>
  	<form id="form1">
  		...
  		<div id="error" style="text-align: center;width: 100%;color: #ff0000;" ></div>
  		 <div class="login_h_e">
  		 	<img src="../images/main/e_mail.png" width="115px" height="31px"/>
    ...
    <div class="login_h_jq"><img src="../images/main/jqqd.png" width="219px" height="26px"/></div>
</div>
