	...
	<div class="c_right">
      <div class="right_subMenu">
            <ul>
                ...
                <li><a href="javascript:void(0);">添加收藏</a></li>
            </ul>
        </div>
      <div class="r_column">
            <div class="column">相关问题</div>
              <div class="column_xgwt">
                    ...
                    <ul>
                        <li><a href="javascript:void(0);">为什么人们貌似能接受劣质的互联网产品，却不能……</a></li>
 
                      <li><a href="javascript:void(0);">什么是运营（仅对互联网公司）？运营团队最重……</a></li>
                         
                        <li><a href="javascript:void(0);">电信行业的我，如何进入互联网行业公司工作……</a></li>
                         
                        <li><a href="javascript:void(0);">如果可能的话，你想建设一个什么样的个人……</a></li>
        ...
        <div class="r_column">
            <div class="column_yqtr"><a href="javascript:void(0);">邀请他人回答（20）</a></div>
      </div>
        <div class="r_column">
