...
<head>
	...
	<script type="text/javascript" src="list_xgwt.js"></script>
</head>
...
<body>
	...
	<div class="content">
		<div class="c_left">
	      ...
	      <div class="subMenu">
	      	<input type="hidden" id="problemId" value="${param.problemId }">
	      	<ul><li class="re"><a href="javascript:void(0);">相关问题</a></li></ul>
	      </div>
