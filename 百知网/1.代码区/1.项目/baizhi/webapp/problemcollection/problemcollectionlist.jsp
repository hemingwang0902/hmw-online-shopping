...
<script type="text/javascript" language="javascript"  src="problemcollectionlist.js"></script>
</head>
<body>
...
<div class="container">
	<div class="content">
		<div class="find_box">
			...
			<form id="ProblemCollectionList" >
				<table width="100%;" border="0" cellspacing="0" cellpadding="0" class="lightbox_table">
		   			<tr>
						<td class="lightbox_title">问题收藏ID：</td>
						<td class="lightbox_content"><input type="text" class="input_width3" name="COLLECTION_ID" id="COLLECTION_ID" /> </td>
					</tr>
		   			<tr>
		   			...
		   			<tr>
						<td class="lightbox_title">是否收藏(0否、1是)：</td>
						<td class="lightbox_content"><input type="text" class="input_width3" name="IS_COLLECTION" id="IS_COLLECTION" /> </td>
					</tr>
		   			<tr>
		...
		<div class="table_box">
			<div class="lightbox_header">
				<span class="font_span">问题收藏信息表列表</span>
			</div>
			<div class="lightbox_opt">
				<input type="button"  value="新增" class="button_box" onclick="location.href='initProblemCollectionForm.go';"/>
			...
			<div class="list_style">
				<table width="100%;" border="0" cellspacing="0" cellpadding="0" class="lightbox_table" id="datalist">
					<tr class="tr_bg">
						...
						<td width="10%">操作</td>
		   				<td width="10%">问题收藏ID</td>
		   				<td width="10%">问题ID</td>
		   				<td width="10%">是否收藏(0否、1是)</td>
		   				<td width="10%">用户ID</td>
		   				<td width="10%">创建时间</td>
		   				<td width="10%">修改时间</td>
					</tr>
