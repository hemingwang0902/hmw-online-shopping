...
<script type="text/javascript" language="javascript"  src="diclistlist.js"></script>
</head>
<body>
	...
	<div class="content">
			...
			<form id="DiclistList" >
				<table width="100%;" border="0" cellspacing="0" cellpadding="0" class="lightbox_table">
		   			...
		   			<tr>
						...
						<td class="lightbox_content"><input type="text" class="input_width3" name="CODE" id="CODE" /> </td>
					</tr>
		   			<tr>
		...
		<div class="table_box">
			<div class="lightbox_header">
				<span class="font_span">字典列表列表</span>
			</div>
			<div class="lightbox_opt">
				<input type="button"  value="新增" class="button_box" onclick="location.href='initDiclistForm.go';"/>
