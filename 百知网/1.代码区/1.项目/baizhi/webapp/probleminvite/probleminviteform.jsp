...
<script type="text/javascript" language="javascript" src="probleminviteform.js"></script>
</head>
<body>
...
<div class="container">
	<div class="content">
		...
		<form action="saveProblemInvite.go" method="post" id="ProblemInviteForm">
			<input type="hidden"  id="INVITE_ID" name="INVITE_ID" value='<s:property value="INVITE_ID"/>' />
			<s:token></s:token>
			<input type="hidden" id="ID" name="ID" value='<s:property value="ID"/>'/>
			<div class="lightbox_header"><span class="font_span">问题邀请人信息表表单</span></div>
			<div class="btn_box">
				<input type="submit" value="保存" class="button_box"/>
				<input type="button" value="返回" onclick="location.href='probleminvitelist.jsp';" class="button_box"/>
			</div>
			<div class="form_style">
				<table width="100%;" border="0" cellspacing="0" cellpadding="0" class="lightbox_table">
					<tr>
						...
						<td class="lightbox_title"><span class="font_red">*</span>是否回答(0否、1是)：</td>
					...
					<tr>
						...
						<td class="lightbox_title"><span class="font_red">*</span>被邀请的用户ID：</td>
						<td class="lightbox_content"><input type="text" class="input_width" id="WAS_USER_ID" name="WAS_USER_ID" value='<s:property value="WAS_USER_ID"/>'/></td>
					</tr>
					<tr>
