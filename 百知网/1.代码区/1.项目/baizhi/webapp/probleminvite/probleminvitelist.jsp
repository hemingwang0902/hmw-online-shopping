...
<script type="text/javascript" language="javascript"  src="probleminvitelist.js"></script>
</head>
<body>
...
<div class="container">
	<div class="content">
		<div class="find_box">
			...
			<form id="ProblemInviteList" >
				<table width="100%;" border="0" cellspacing="0" cellpadding="0" class="lightbox_table">
		   			<tr>
						<td class="lightbox_title">问题邀请人ID：</td>
						<td class="lightbox_content"><input type="text" class="input_width3" name="INVITE_ID" id="INVITE_ID" /> </td>
					</tr>
		   			<tr>
		   			...
		   			<tr>
						<td class="lightbox_title">是否回答(0否、1是)：</td>
		   			...
		   			<tr>
						<td class="lightbox_title">被邀请的用户ID：</td>
						<td class="lightbox_content"><input type="text" class="input_width3" name="WAS_USER_ID" id="WAS_USER_ID" /> </td>
					</tr>
		   			<tr>
		...
		<div class="table_box">
			<div class="lightbox_header">
				<span class="font_span">问题邀请人信息表列表</span>
			</div>
			<div class="lightbox_opt">
				<input type="button"  value="新增" class="button_box" onclick="location.href='initProblemInviteForm.go';"/>
			...
			<div class="list_style">
				<table width="100%;" border="0" cellspacing="0" cellpadding="0" class="lightbox_table" id="datalist">
					<tr class="tr_bg">
						...
						<td width="10%">操作</td>
		   				<td width="10%">问题邀请人ID</td>
		   				<td width="10%">问题ID</td>
		   				<td width="10%">是否回答(0否、1是)</td>
		   				<td width="10%">用户ID</td>
		   				<td width="10%">被邀请的用户ID</td>
		   				<td width="10%">创建时间</td>
		   				<td width="10%">修改时间</td>
					</tr>
				</table> 
