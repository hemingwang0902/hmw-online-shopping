...
<script type="text/javascript" language="javascript" src="problemanswerform.js"></script>
</head>
<body>
...
<div class="container">
	<div class="content">
		...
		<form action="saveProblemAnswer.go" method="post" id="ProblemAnswerForm">
			<input type="hidden"  id="ANSWER_ID" name="ANSWER_ID" value='<s:property value="ANSWER_ID"/>' />
			<s:token></s:token>
			<input type="hidden" id="ID" name="ID" value='<s:property value="ID"/>'/>
			<div class="lightbox_header"><span class="font_span">问题答案信息表表单</span></div>
			<div class="btn_box">
				<input type="submit" value="保存" class="button_box"/>
				<input type="button" value="返回" onclick="location.href='problemanswerlist.jsp';" class="button_box"/>
			</div>
			<div class="form_style">
				<table width="100%;" border="0" cellspacing="0" cellpadding="0" class="lightbox_table">
					...
					<tr>
						...
						<td class="lightbox_title"><span class="font_red">*</span>赞成数量：</td>
						<td class="lightbox_content"><input type="text" class="input_width" id="AGREE_COUNT" name="AGREE_COUNT" value='<s:property value="AGREE_COUNT"/>'/></td>
					</tr>
					<tr>
						<td class="lightbox_title"><span class="font_red">*</span>反对数量：</td>
						<td class="lightbox_content"><input type="text" class="input_width" id="DISAGREE_COUNT" name="DISAGREE_COUNT" value='<s:property value="DISAGREE_COUNT"/>'/></td>
						<td class="lightbox_title"><span class="font_red">*</span>感觉作者数量：</td>
						<td class="lightbox_content"><input type="text" class="input_width" id="THANK_COUNT" name="THANK_COUNT" value='<s:property value="THANK_COUNT"/>'/></td>
					</tr>
					<tr>
						<td class="lightbox_title"><span class="font_red">*</span>没有帮助数量：</td>
						<td class="lightbox_content"><input type="text" class="input_width" id="DISTHANK_COUNT" name="DISTHANK_COUNT" value='<s:property value="DISTHANK_COUNT"/>'/></td>
