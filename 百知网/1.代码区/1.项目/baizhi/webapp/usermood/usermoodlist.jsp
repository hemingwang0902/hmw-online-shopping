...
<script type="text/javascript" language="javascript"  src="usermoodlist.js"></script>
</head>
<body>
	...
	<div class="content">
		<div class="find_box">
			...
			<form id="UserMoodList" >
				<table width="100%;" border="0" cellspacing="0" cellpadding="0" class="lightbox_table">
		   			...
		   			<tr>
						<td class="lightbox_title">心情随记的内容：</td>
						<td class="lightbox_content"><input type="text" class="input_width3" name="descript" id="descript" /> </td>
					</tr>
		   			<tr>
						<td class="lightbox_title">发表时间：</td>
						<td class="lightbox_content"><input type="text" class="input_width3 Wdate"  onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',autoPickDate:true})" name="publish_time" id="publish_time" /> </td>
					</tr>
					<tr>
						<td>&nbsp;</td>
		...
		<div class="table_box">
			<div class="lightbox_header">
				<span class="font_span">用户心情随记列表</span>
			</div>
			<div class="lightbox_opt">
				<input type="button"  value="新增" class="button_box" onclick="location.href='initUserMoodForm.go';"/>
