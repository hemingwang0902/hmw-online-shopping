...
<script type="text/javascript" language="javascript"  src="answerreviewlist.js"></script>
</head>
<body>
...
<div class="container">
	<div class="content">
		<div class="find_box">
			...
			<form id="AnswerReviewList" >
				<table width="100%;" border="0" cellspacing="0" cellpadding="0" class="lightbox_table">
		   			<tr>
						<td class="lightbox_title">问题答案评论ID：</td>
						<td class="lightbox_content"><input type="text" class="input_width3" name="REVIEW_ID" id="REVIEW_ID" /> </td>
					</tr>
		   			<tr>
		   			...
		   			<tr>
						<td class="lightbox_title">问题答案评论ID父ID：</td>
						<td class="lightbox_content"><input type="text" class="input_width3" name="PREVIEW_ID" id="PREVIEW_ID" /> </td>
					</tr>
		   			<tr>
		...
		<div class="table_box">
			<div class="lightbox_header">
				<span class="font_span">问题答案评论信息表列表</span>
			</div>
			<div class="lightbox_opt">
				<input type="button"  value="新增" class="button_box" onclick="location.href='initAnswerReviewForm.go';"/>
			...
			<div class="list_style">
				<table width="100%;" border="0" cellspacing="0" cellpadding="0" class="lightbox_table" id="datalist">
					<tr class="tr_bg">
						...
						<td width="10%">操作</td>
		   				<td width="10%">问题答案评论ID</td>
		   				<td width="10%">问题答案ID</td>
		   				<td width="10%">问题ID(冗余字段)</td>
		   				<td width="10%">内容</td>
		   				<td width="10%">问题答案评论ID父ID</td>
		   				<td width="10%">用户ID</td>
		   				<td width="10%">创建时间</td>
		   				<td width="10%">修改时间</td>
					</tr>
