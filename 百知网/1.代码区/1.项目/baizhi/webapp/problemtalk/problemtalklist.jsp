...
<script type="text/javascript" language="javascript"  src="problemtalklist.js"></script>
</head>
<body>
...
<div class="container">
	<div class="content">
		<div class="find_box">
			...
			<form id="ProblemTalkList" >
				<table width="100%;" border="0" cellspacing="0" cellpadding="0" class="lightbox_table">
		   			<tr>
						<td class="lightbox_title">问题话题ID：</td>
						<td class="lightbox_content"><input type="text" class="input_width3" name="PROBLEMTALK_ID" id="PROBLEMTALK_ID" /> </td>
					</tr>
		   			<tr>
						<td class="lightbox_title">话题ID：</td>
		...
		<div class="table_box">
			<div class="lightbox_header">
				<span class="font_span">问题话题信息表列表</span>
			</div>
			<div class="lightbox_opt">
				<input type="button"  value="新增" class="button_box" onclick="location.href='initProblemTalkForm.go';"/>
