...
<script type="text/javascript" language="javascript"  src="talktypelist.js"></script>
</head>
<body>
...
<div class="container">
	<div class="content">
		<div class="find_box">
			...
			<form id="TalktypeList" >
				<table width="100%;" border="0" cellspacing="0" cellpadding="0" class="lightbox_table">
		   			<tr>
						<td class="lightbox_title">类型名称：</td>
						<td class="lightbox_content"><input type="text" class="input_width3" name="TYPE_NAME" id="TYPE_NAME" /> </td>
					</tr>
					<tr>
						<td>&nbsp;</td>
		...
		<div class="table_box">
			<div class="lightbox_header">
				<span class="font_span">话题类型列表</span>
			</div>
			<div class="lightbox_opt">
				<input type="button"  value="新增" class="button_box" onclick="location.href='initTalktypeForm.go';"/>
			</div>
